...
public class ServerProgram {
	...
	public static void main(String[] args) {
		 ...
		 * 데이터를 교환하기에 앞서 서버, 클라이언트가 연결되어있어야함! (서버가 먼저 실행되어 클라이언트 요청 기다릴거임)
		 * 신뢰성 있는 데이터 전달 가능
		 * 
		 * 소켓(Socket)
		 * 프로세서간의 통신을 담당
		 * InputStream / OutputStream을 가지고 있음 (이 스트림을 통해 입출력 이루어짐)
		 * 
		 * Server Socket
		 * 포트와 연결되어(Bind) 외부의 연결요청 기다리다 연결요청 들어오면 수락해줄 용도
