...
public class B_Switch {
	 ...
	 * switch는 동등비교로 밖에 수행되지 않음.
	 * 
	 * 실행할 구문만 실행을 하고 자동으로 빠져나오지 못함. (break;문을 작성해야함.)
	 * 
	 * [표현법]
...
//		}
		...
		case 3: 
			...
			break;
		default : 
			System.out.println("잘못입력했습니다."); // 여긴 거나마나..
		}
	...
	public void method4() {
		// 월을 입력을 받아서 해당 월의 마지막 날짜를 출력하는 프로그램
		Scanner sc = new Scanner(System.in);
