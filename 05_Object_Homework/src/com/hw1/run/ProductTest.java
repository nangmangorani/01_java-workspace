...
public class ProductTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("부가세 포함 가격 : " + p1.calculate(p1.getPrice(), p1.getTax()) + "원");
		System.out.println("상품명 = " + p2.getProductName());
		System.out.println("부가세 포함 가격 : " + p2.calculate(p2.getPrice(), p2.getTax()) + "원");
		System.out.println("상품명 = " + p3.getProductName());
		System.out.println("부가세 포함 가격 : " + p3.calculate(p3.getPrice(), p3.getTax()) + "원");
