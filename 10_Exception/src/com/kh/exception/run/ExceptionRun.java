...
public class ExceptionRun {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 컴파일에러 : 소스코드 문법상 오류 => 빨간색으로 애초에 오류로 알려줌 (개발자의 실수)
		 * 런타임에러 : 코드 상으로 문제가 없는데 프로그램 실행중에 발생하는 에러 (사용자의 실수일 수도 있고 개발자의 실수일 수도 있다. (예외처리))
		 * 
		 * 논리에러 : 문법적으로 문제없고 실행했을 때도 굳이 문제는 없지만 프로그램 의도상 맞지않는것.
		 * 
