...
//		System.out.println(baby);
		...
		// Basic b = new Basic(); // 레퍼런스 변수로는 사용가느앟나 객체 생성은 불가능함
		 ...
		 * 인터페이스에서 인터페이스를 상속 : 인터페이스 extends 인터페이스1, 인터페이스2,...(다중상속가능)
		 * 
		 * 
		 * 				|		추상클래스		|		인터페이스
		 * ================================================================
		 ...
		 * 일반메소드 여부	|		o			|		x
		 * ----------------------------------------------------------------
		 * 필드			|		일반필드가능	|상수필드만 가질 수 있음(묵시적으로 public static final)
		 * 
		 * 
