...
public class PropertiesRun1 {
	...
	// Properties : Map 계열의 컬렉션 => 키 + 밸류 세트로 저장
	// HashMap과의 차이점 : Properties에는 키값도 String, 밸류도 String으로 담음!
...
//		
//		// 하지만 properties 사용하는 경우 주로 Properties에 담긴 것들을 파일로 출력 또는 입력 받아올 때 사용함!
...
//		}
		...
		System.out.println(prop); // 역시 저장순서 유지 x key값 중복시 덮여씌워짐
		
		// 2. getProperty(String key) : String
		System.out.println(prop.getProperty("List"));
		System.out.println(prop.getProperty("새우깡")); // 존재하지 않는 key값 제시시 null 반환
