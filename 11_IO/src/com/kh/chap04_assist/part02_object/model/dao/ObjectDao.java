...
public class ObjectDao {
	...
	// 프로그램 -----> 파일 (출력)
	// 파일은 사실 우리가 보려고 관상용으로 만든다기 보다 나중에 읽어오기위해 만드는 것, 컴퓨터가 읽기좋아야함.
	...
	public void fileRead() {
		...
		try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("d_phone.txt"))) {
			...
			/*
			 * System.out.println(ois.readObject()); System.out.println(ois.readObject());
			 * System.out.println(ois.readObject()); //System.out.println(ois.readObject());
			 * // 파일의 끝을 만나는 순간 예외발생 : EOFException
			 */
